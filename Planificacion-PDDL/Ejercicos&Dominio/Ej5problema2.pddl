(define (problem belkan-test5)

  (:domain belkan5-domain)
  ...
  (:goal (AND
     (= (magic-pocket witch) 1)
     (= (magic-pocket knight) 1)
     (= (magic-pocket teacher) 1)
     (= (magic-pocket princess) 1)
     (= (magic-pocket actor) 1)
	 ;(<= (total-cost) 120)
    ; (>= (points) 50)
         )
  )
