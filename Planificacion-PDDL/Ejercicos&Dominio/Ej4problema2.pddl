(define (problem belkan-test4)
  ...
  (:objects z1 z2 z3 z4 z5 z6 z7 z8 z9 z10 z11 z12 z13 z14
        ...
        belkan - player
        n e w s - orientation
        boots bikini apple1 apple2 book1 book2 book3 - object
  )
  (:init
      ;------------------------------------------------------------
      ...
      (covered z25 lake)
        ...
        (at z7 apple1) (on-floor apple1)
    	(at z10 apple2) (on-floor apple2)
    	(at z14 book1) (on-floor book1)
    	(at z12 book2) (on-floor book2)
    	(at z2 book3) (on-floor book3)
        ...
        (= (value apple1 witch) 10)
        (= (value apple2 witch) 10)
        (= (value rose witch) 5)
        (= (value book1 witch) 1)
        (= (value book2 witch) 1)
        (= (value book3 witch) 1)
        ...
        (= (value apple1 princess) 1)
        (= (value apple2 princess) 1)
        (= (value rose princess) 10)
        (= (value book1 princess) 3)
        (= (value book2 princess) 3)
        (= (value book3 princess) 3)
        (= (value gold princess) 4)
        (= (value oscar princess) 5)

        (= (value apple1 actor) 3)
        (= (value apple2 actor) 3)
        (= (value rose actor) 1)
        (= (value book1 actor) 4)
        (= (value book2 actor) 4)
        (= (value book3 actor) 4)
        ...
        (= (value apple1 knight) 4)
        (= (value apple2 knight) 4)
        (= (value rose knight) 3)
        (= (value book1 knight) 5)
        (= (value book2 knight) 5)
        (= (value book3 knight) 5)
        (= (value gold knight) 10)
        (= (value oscar knight) 1)

        (= (value apple1 teacher) 5)
        (= (value apple2 teacher) 5)
        (= (value rose teacher) 4)
        (= (value book1 teacher) 10)
        (= (value book2 teacher) 10)
        (= (value book3 teacher) 10)
