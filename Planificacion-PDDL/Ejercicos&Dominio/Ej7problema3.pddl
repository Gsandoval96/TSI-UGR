(define (problem belkan-test7)

  (:domain belkan7-domain)
  ...
  (:init
	...
	(at z3 witch) (NPC witch)
	(at z9 princess) (NPC princess)
	(at z11 actor) (NPC actor)
	(at z21 knight) (NPC knight)
	(at z20 teacher) (NPC teacher)

    (= (magic-pocket witch) 0)
    (= (magic-pocket princess) 0)
    (= (magic-pocket actor) 0)
    (= (magic-pocket knight) 0)
    (= (magic-pocket teacher) 0)
